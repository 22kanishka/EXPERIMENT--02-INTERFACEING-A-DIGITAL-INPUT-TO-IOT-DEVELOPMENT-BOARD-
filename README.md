...
## Output  :
:<img width="900" height="1600" alt="148b3da1-7050-4ca2-9087-92398cdc310b" src="https://github.com/user-attachments/assets/0b2985b5-aaee-4860-8a2c-da392ace0dac" />

<img width="456" height="391" alt="image" src="https://github.com/user-attachments/assets/276d1c66-1e2e-4715-99ae-10e15f17d737" />
...
## Result :
Thus, the IR pair was successfully interfaced with the ARM IoT development board using STM32 Cube IDE. The digital input from the IR sensor was read through GPIOB Pin 4, and the corresponding output was controlled through GPIOA Pin 0. The program was successfully compiled, flashed, and executed on the board, and the expected output was obtained.
